...
api_token='f9afd0422bd1a474ad0d166a6881d978bbcf8a006b15e99b9d5bf9ea68a29a8491d1a7b0b9a2d9543c5fa'
vk = vk_api.VkApi(token = api_token, api_version='5.73') # Токен Vk Api
#vk.auth(token_only=True) # Авторизация
